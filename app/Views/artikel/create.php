...
<div class="d-flex align-items-center gap-2 mb-3">
    ...
    <div>
        ...
        <small class="text-muted">Tulis artikel baru untuk website desa</small>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <form action="<?= site_url('artikel/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-12">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-text">Max 3 MB. JPG, PNG, WEBP.</div>
                </div>
                <div class="col-12">
                    <label class="form-label fw-semibold">Isi Artikel <span class="text-danger">*</span></label>
                    <textarea name="isi" id="isiArtikel" class="form-control" rows="12"
            ...
            <div class="d-flex gap-2">
                ...
                <button type="submit" class="btn btn-outline-secondary" onclick="document.querySelector('[name=status]').value='draft'">Simpan sebagai Draft</button>
