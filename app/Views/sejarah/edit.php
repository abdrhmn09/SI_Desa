...
<div class="mb-3">
    <h4 class="fw-bold mb-0">Edit Sejarah Kepemimpinan</h4>
    <p class="text-muted small mb-0">Perbarui data tokoh kepemimpinan desa.</p>
</div>

<div class="card">
    <div class="card-body">
        <form action="<?= site_url('sejarah/' . $sejarah['id']) ?>" method="post">
            <?= csrf_field() ?>

            <div class="mb-3">
                <label for="nama" class="form-label fw-semibold">Nama Tokoh</label>
                <input type="text" name="nama" id="nama" class="form-control"
                       value="<?= old('nama', $sejarah['nama']) ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="masa_jabatan" id="masa_jabatan" class="form-control"
                       value="<?= old('masa_jabatan', $sejarah['masa_jabatan']) ?>" required>
            </div>

            <div class="mb-4">
                <label for="keterangan" class="form-label fw-semibold">Keterangan <span class="text-muted fw-normal">(opsional)</span></label>
                <textarea name="keterangan" id="keterangan" class="form-control" rows="4"><?= old('keterangan', $sejarah['keterangan'] ?? '') ?></textarea>
            </div>
