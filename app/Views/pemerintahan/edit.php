...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card">
            <div class="card-body">
                <form action="<?= site_url('pemerintahan/update/'.$pejabat['id']) ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Nama Jabatan <span class="text-danger">*</span></label>
                        <input type="text" name="nama_jabatan" class="form-control"
                            value="<?= old('nama_jabatan', $pejabat['nama_jabatan']) ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tahun" class="form-control"
                            value="<?= old('tahun', $pejabat['tahun']) ?>" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-semibold">Foto</label>
                        <?php if (!empty($pejabat['foto'])): ?>
                        <div class="mb-2 d-flex align-items-center gap-2">
                            <img src="<?= base_url('uploads/pejabat/'.$pejabat['foto']) ?>"
