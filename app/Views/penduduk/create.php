...
<div class="d-flex align-items-center gap-2 mb-3">
    ...
    <div>
        ...
        <small class="text-muted">Isi form berikut untuk menambahkan data penduduk baru</small>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <form action="<?= site_url('penduduk/store') ?>" method="post">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">NIK <span class="text-danger">*</span></label>
                    <input type="text" name="nik" class="form-control font-monospace" maxlength="16" value="<?= old('nik') ?>" placeholder="16 digit NIK" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="pekerjaan" class="form-control" value="<?= old('pekerjaan') ?>" placeholder="Contoh: Petani, PNS, Wiraswasta...">
                </div>
            </div>
            <hr class="my-4">
